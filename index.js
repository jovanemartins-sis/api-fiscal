...
app.post('/emitir-nfce', (req, res) => {
    try {
        ...
        const key = forge.pki.privateKeyToPem(p12.getBags({ bagType: forge.pki.oids.pkcs8ShroudedKeyBag }).pkcs8ShroudedKeyBag[0].key);
        ...
        res.json({ sucesso: true, xmlAssinado: sig.getSignedXml() });
